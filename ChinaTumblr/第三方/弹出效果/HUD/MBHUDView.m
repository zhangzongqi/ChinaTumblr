...
+ (MBHUDView*)hudWithBody:(NSString*)body type:(MBAlertViewHUDType)type hidesAfter:(float)delay backGroundColorWithWhite:(CGFloat)whiteFloat show:(BOOL)show {
    MBHUDView *alert = [[MBHUDView alloc] init];
    alert.bodyText = body;
    alert.hudType = type;
    alert.hudHideDelay = delay;
    alert.itemColor = [UIColor whiteColor];
    alert.backgroundColor = [UIColor colorWithWhite:whiteFloat alpha:0.9];
    ...
    if(type == MBAlertViewHUDTypeExclamationMark) {
        ...
        if (whiteFloat == 0.0) {
            ...
            alert.iconLabel.textColor = [UIColor blackColor];
        }
    ...
    if (type == MBAlertViewHUDTypeLabelIcon) {
        alert.hudType = MBAlertViewHUDTypeLabelIcon;
        if (whiteFloat == 0.0) {
            alert.iconLabel.textColor = [UIColor whiteColor];
        }else {
        ...
        alert.iconLabel.text = body;
        alert.animationType = MBAlertAnimationTypeBounce;
    }
