...
//    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(startX, lineWidth / 2.0, width, height - lineWidth) cornerRadius:self.cornerRadius];
    ...
    // 修改后样式（一个单元格的一半）
//    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(startX + width / 4, lineWidth / 2.0, width / 2, height - lineWidth) cornerRadius:self.cornerRadius];
    // 修改后样式（一个单元格的2/5）
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(startX + width / 4+ width / 20, lineWidth / 2.0, width * 2 / 5, height - lineWidth) cornerRadius:self.cornerRadius];
